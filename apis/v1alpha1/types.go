...
// +kubebuilder:resource:scope=Namespaced,categories={crossplane,provider,dynatrace}
// A ProviderConfig configures a Dynatrace provider.
...
// +kubebuilder:printcolumn:name="AGE",type="date",JSONPath=".metadata.creationTimestamp"
// +kubebuilder:printcolumn:name="SECRET-NAME",type="string",JSONPath=".spec.credentials.secretRef.name",priority=1
// +kubebuilder:resource:scope=Cluster,categories={crossplane,provider,dynatrace}
// A ClusterProviderConfig configures a Dynatrace provider.
